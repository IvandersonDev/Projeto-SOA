...
echo.
echo 3. Listando topicos...
docker exec kafka kafka-topics --bootstrap-server localhost:29092 --list

echo.
echo 4. Verificando detalhes dos topicos principais...
...
echo.
echo 5. Garantindo topico de teste...
...
docker exec kafka bash -lc "echo 'hello-from-check' | kafka-console-producer --broker-list localhost:29092 --topic test-topic" >nul 2>&1
if %errorlevel% neq 0 (
